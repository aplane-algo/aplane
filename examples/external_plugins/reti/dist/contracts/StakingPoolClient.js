 ...
 */
export function StakedInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.StakedInfo, APP_SPEC.structs);
}
/**
 ...
 */
export class StakingPoolParamsFactory {
    /**
    ...
    * Updates the balance of stakers in the pool based on the received 'rewards' (current balance vs known staked balance)
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static epochBalanceUpdate(params) {
        return {
            ...params,
    ...
    * proxiedSetTokenPayoutRatio is meant to be called by pools != 1 - calling US, pool #1
     ...
     * @returns An `AppClientMethodCallParams` object for the call
     */
    static proxiedSetTokenPayoutRatio(params) {
        return {
            ...params,
...
export class StakingPoolFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? StakingPoolParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
    ...
    send = {
        ...
        create: {
            ...
            createApplication: async (params) => {
                ...
                return { result: { ...result.result, return: result.result.return }, appClient: new StakingPoolClient(result.appClient) };
            },
        },
    };
}
...
export class StakingPoolClient {
    ...
    params = {
        ...
        * Updates the balance of stakers in the pool based on the received 'rewards' (current balance vs known staked balance)
         ...
         * @returns The call params
         */
        epochBalanceUpdate: (params = { args: [] }) => {
        ...
        * proxiedSetTokenPayoutRatio is meant to be called by pools != 1 - calling US, pool #1
         ...
         * @returns The call params
         */
        proxiedSetTokenPayoutRatio: (params) => {
    ...
    send = {
        ...
        * Updates the balance of stakers in the pool based on the received 'rewards' (current balance vs known staked balance)
         ...
         * @returns The call result
         */
        epochBalanceUpdate: async (params = { args: [] }) => {
        ...
        * proxiedSetTokenPayoutRatio is meant to be called by pools != 1 - calling US, pool #1
         ...
         * @returns The call result
         */
        proxiedSetTokenPayoutRatio: async (params) => {
    ...
    state = {
        ...
        global: {
             ...
             */
            creatingValidatorContractAppId: async () => { return (await this.appClient.state.global.getValue("creatingValidatorContractAppId")); },
            /**
             * Get the current value of the validatorId key in global state
             */
            validatorId: async () => { return (await this.appClient.state.global.getValue("validatorId")); },
            /**
             * Get the current value of the poolId key in global state
             */
            poolId: async () => { return (await this.appClient.state.global.getValue("poolId")); },
            /**
             ...
             */
            minEntryStake: async () => { return (await this.appClient.state.global.getValue("minEntryStake")); },
            /**
             * Get the current value of the lastPayout key in global state
             */
            lastPayout: async () => { return (await this.appClient.state.global.getValue("lastPayout")); },
            /**
             * Get the current value of the epochNumber key in global state
             */
            epochNumber: async () => { return (await this.appClient.state.global.getValue("epochNumber")); },
            /**
             * Get the current value of the algodVer key in global state
             */
            algodVer: async () => { return new BinaryStateValue((await this.appClient.state.global.getValue("algodVer"))); },
            /**
             * Get the current value of the roundsPerDay key in global state
             */
            roundsPerDay: async () => { return (await this.appClient.state.global.getValue("roundsPerDay")); },
            /**
             * Get the current value of the binRoundStart key in global state
             */
            binRoundStart: async () => { return (await this.appClient.state.global.getValue("binRoundStart")); },
            /**
             * Get the current value of the stakeAccumulator key in global state
             */
            stakeAccumulator: async () => { return (await this.appClient.state.global.getValue("stakeAccumulator")); },
            /**
             * Get the current value of the rewardAccumulator key in global state
             */
            rewardAccumulator: async () => { return (await this.appClient.state.global.getValue("rewardAccumulator")); },
            /**
             * Get the current value of the weightedMovingAverage key in global state
             */
            weightedMovingAverage: async () => { return (await this.appClient.state.global.getValue("weightedMovingAverage")); },
        },
        /**
        ...
        box: {
             ...
             */
            stakers: async () => { return (await this.appClient.state.box.getValue("stakers")); },
        },
    };
    newGroup() {
        const client = this;
