#!/usr/bin/env python3
"""Launch the atomic group swap buyer agent."""
...
from deploy_contract import ensure_swap_app
from swap_log import LOG_PATH
...
if __name__ == "__main__":
    ...
    # Ensure the box storage contract is deployed
    ensure_swap_app()
