...
var expectedContractFixtureNames = []string{
	...
	"admin_sync_attestors_request.json",
	"admin_sync_attestors_response.json",
	"attested_assembly_request_mixed.json",
	"attested_assembly_response.json",
	"cancel_sign_request.json",
	"cancel_sign_response_not_found.json",
	"cancel_sign_response_success.json",
	"component_sign_request_attestor.json",
	"component_sign_response_attestor.json",
	"error_response.json",
	"group_plan_response_mutated.json",
	"group_sign_request_mixed.json",
	"group_sign_response_mutated.json",
	"health_response_ready.json",
	"keys_response_attested.json",
...
func TestSignerAPIContractFixturesRoundTrip(t *testing.T) {
	tests := []struct {
		...
		{"keys_response_attested.json", assertContractRoundTrip[KeysResponse]},
		...
		{"admin_sync_attestors_request.json", assertContractRoundTrip[AdminSyncAttestorReferencesRequest]},
		{"admin_sync_attestors_response.json", assertContractRoundTrip[AdminSyncAttestorReferencesResponse]},
		...
		{"component_sign_request_attestor.json", assertContractRoundTrip[ComponentSignRequest]},
		{"component_sign_response_attestor.json", assertContractRoundTrip[ComponentSignResponse]},
		{"attested_assembly_request_mixed.json", assertContractRoundTrip[AttestedAssemblyRequest]},
		{"attested_assembly_response.json", assertContractRoundTrip[AttestedAssemblyResponse]},
