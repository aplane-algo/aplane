...
| Plaintext template library | install source | repo or signer-data `library/templates/*.yaml` | KeyType Library candidates | `internal/templatelibrary` | Not active until installed/enabled; invalid entries reported, not enabled. |
