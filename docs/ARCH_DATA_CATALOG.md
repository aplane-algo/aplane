...
| Deleted archive root | inactive durable storage | `identities/default/deleted/` | outside active key/template scans | `internal/keys`, `internal/templatestore` | Deleted keys/templates are not active authority. |
