...
- `key_details.parameters` for attested account keys projects the embedded attestor verifier as `Attestor: <a_ component selector>` and does not expose the raw `attestor_public_key` parameter
