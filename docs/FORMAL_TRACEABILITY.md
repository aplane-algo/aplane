...
| BS3 | implemented | BS3 | `internal/signerapp/signing/bounded_sentry.go::assembleBoundedTarget` | `internal/signerapp/signing/bounded_sentry_test.go::TestAssembleBoundedTargetVerifiesBothAuthorities` | Spend assembly verifies the assembly receipt and both authorities against durable metadata. Machine-checked in `bounded_sentry.tla` (`BS3_SpendAuthoritiesVerified`, including the receipt conjunct). |
...
branch. TLC generated 199,168 distinct states with no counterexamples. Target
