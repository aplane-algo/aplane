...
| Signer library template | `library/templates/<key_type>.yaml` | Install source only; not active by itself. New signer identities install the bundled Falcon whitelist source during initialization. |
