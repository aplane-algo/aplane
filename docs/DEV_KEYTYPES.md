...
`internal/keytypecatalog`: `ed25519` and `aplane.falcon1024.v1` are default-enabled,
while `aplane.falcon1024_ed25519.v1` and `aplane.ecdsak1.v1` are library-visible and hidden
