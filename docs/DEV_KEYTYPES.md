...
| `aplane.falcon1024-attested.v1` | Attested-account DSA LogicSig provider | Go-defined | default-enabled | `lsig/falcon1024_attested` |
...
`aplane.falcon1024-attested.v1` are default-enabled, while
