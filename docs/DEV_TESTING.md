...
| `TestIncludedKeyTypesSignInBatchedGroups` | Imports bundled templates, activates opt-in compiled key types, generates/funds accounts including `aplane.ed25519-whitelist.v1`, and signs positive/negative grouped transactions |
