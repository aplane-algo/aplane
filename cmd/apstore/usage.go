...
func apstoreUsage() {
	...
	fmt.Fprintf(os.Stderr, "  apstore [-d path] rebuild <archive-path> [--role signer|attestor] [--address ADDRESS ...]\n")
	...
	fmt.Fprintf(os.Stderr, "  apstore rebuild /mnt/usb/aplane-attestor-backup.tar.gz --role attestor\n")
	...
	fmt.Fprintf(os.Stderr, "  apstore keytype enable falcon1024_ed25519.v1\n")
