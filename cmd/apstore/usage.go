...
func apstoreUsage() {
	...
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore apply <backup-id|name> [--address ADDRESS ...] [--overwrite] [--acknowledge-unattended-signing]\n")
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore list\n")
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore review <restore-id>\n")
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore activate <restore-id> [--replace-existing] [--acknowledge-unattended-signing]\n")
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore rollback <restore-id>\n")
	fmt.Fprintf(os.Stderr, "  apstore [-d path] restore purge <restore-id>\n")
	...
	fmt.Fprintf(os.Stderr, "  apstore restore list\n")
