...
func apstoreUsage() {
	...
	fmt.Fprintf(os.Stderr, "  apstore [-d path] [--ipc-path path] endpoint export [--host <host> | --url <url>] [--out endpoint.json]\n")
	...
	fmt.Fprintf(os.Stderr, "  --ipc-path path      Admin IPC socket path (or set APSIGNER_IPC_PATH)\n")
	fmt.Fprintf(os.Stderr, "\nExamples:\n")
