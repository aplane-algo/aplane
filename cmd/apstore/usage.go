...
func apstoreUsage() {
	...
	fmt.Fprintf(os.Stderr, "  apstore [-d path] endpoints export (--host <host> | --url <url>) [--out endpoint.json]\n")
	...
	fmt.Fprintf(os.Stderr, "  apstore endpoints export --host 127.0.0.1 --out endpoint.json\n")
