...
func TestOptOutRequestFromParamsPreservesFeeAndLsigArgs(t *testing.T) {
	params, err := shellrepl.ParseOptoutCommand([]string{"usdc", "from", "alice", "to", "bob", "fee=3000", "nowait", "arg:preimage=text:secret"})
	if err != nil {
