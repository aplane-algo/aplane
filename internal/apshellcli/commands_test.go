...
func TestCommandRegistration(t *testing.T) {
	...
	expectedCommands := []struct {
		...
		{"app", command.CategoryTransaction},
		...
		{"keytypes", command.CategoryKeyMgmt},
		{"generate", command.CategoryKeyMgmt},
		{"delete", command.CategoryKeyMgmt},
		...
		{"js", command.CategoryAutomation},
		{"jssave", command.CategoryAutomation},
		{"jslist", command.CategoryAutomation},
...
func TestCommandCount(t *testing.T) {
	...
	// Should have at least 25 core commands
	minExpected := 25
