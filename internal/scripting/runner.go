...
// RunnerError represents an error that occurred during script execution.
...
type Runner interface {
	...
	// RunWithContext executes the given code with a caller-owned context for
	// host-side API calls made by the script.
	RunWithContext(ctx context.Context, code string) (Result, error)
