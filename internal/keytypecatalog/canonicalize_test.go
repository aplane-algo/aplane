...
func TestCanonicalize(t *testing.T) {
	tests := []struct {
		...
		{name: "unqualified template unchanged", keyType: "falcon1024-allowlist.v1", want: "falcon1024-allowlist.v1"},
		{name: "bare unqualified unchanged", keyType: "allowlist.v1", want: "allowlist.v1"},
		{name: "trims and lowers unqualified", keyType: " Allowlist.V1 ", want: "allowlist.v1"},
