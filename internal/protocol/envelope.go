...
func InferMessageKind(messageType string) (MessageKind, bool) {
	...
	case MsgTypeAuth,
		...
		MsgTypeRecoverBackup,
		MsgTypeListRecovered,
		MsgTypeReviewRecovered,
		MsgTypeActivateRecovered,
		MsgTypeRollbackRecovered,
		MsgTypePurgeRecovered,
		MsgTypeSignResponse,
	...
	case MsgTypeAuthResult,
		...
		MsgTypeRecoverBackupResult,
		MsgTypeRecoveredList,
		MsgTypeReviewRecoveredResult,
		MsgTypeActivateRecoveredResult,
		MsgTypeRollbackRecoveredResult,
		MsgTypePurgeRecoveredResult,
		MsgTypeError,
		MsgTypeKeysList,
