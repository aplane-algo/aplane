...
func newTestBIP39Handler() *BIP39Handler {
	return NewHandler("falcon1024", 24)
}
...
func TestBIP39Handler_WordCount(t *testing.T) {
	h := newTestBIP39Handler()
	if h.WordCount() != 24 {
...
func TestBIP39Handler_ValidateWordCount(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_GenerateMnemonic(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_GenerateMnemonic_Unique(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_SeedFromMnemonic(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_SeedFromMnemonic_WithPassphrase(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_SeedFromMnemonic_Invalid(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_EntropyToMnemonic(t *testing.T) {
	h := newTestBIP39Handler()
...
func TestBIP39Handler_EntropyToMnemonic_Deterministic(t *testing.T) {
	h := newTestBIP39Handler()
