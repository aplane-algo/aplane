...
func TestManifestValidateDefaults(t *testing.T) {
	m := Manifest{
		...
		Executable:  "test-plugin",
		Commands:    []Command{{Name: "test", Description: "Test"}},
		// No Timeout or ManifestFormat set
	}
...
func TestLoad(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			errMsg:  "protocol_version is no longer supported; use manifest_format",
		},
		{
			name:    "invalid json",
