...
import familyops "github.com/aplane-algo/aplane/lsig/falcon1024/family/ops"

// Ops exposes Falcon signer-side keygen, signing, and mnemonic operations.
type Ops struct {
