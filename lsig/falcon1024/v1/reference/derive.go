...
//
// This package is a TEST-ONLY reference oracle. It is NOT used in production.
// Production derivation lives in keys/derive.go and timelock/derive.go.
// Tests import this package to verify that production derivation produces
// identical addresses to the upstream reference implementation.
//
...
func DerivePQLogicSig(publicKey falcongo.PublicKey) (crypto.LogicSigAccount, error) {
	...
	return crypto.LogicSigAccount{}, family.ErrInvalidFalconPublicKey
}
