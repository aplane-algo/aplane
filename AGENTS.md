...
- `cmd/appolicy/`: Offline policy checker/editor TUI for the node-role policy document (`policy.yaml`, parsed as signer policy on signer nodes and attestor policy on attestor nodes)
